<!-- Sidebar Navigation Left -->
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      ...
      <a href="#" class="text-center ms-logo-img-link"> <img src="https://via.placeholder.com/70" alt="logo"></a>
      <h5 class="text-center text-white mt-2">ADMINISTRATOR</h5>
      <!-- <h6 class="text-center text-white mb-3">USER</h6> -->
